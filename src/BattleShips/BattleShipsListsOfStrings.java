...
public class BattleShipsListsOfStrings {
    ...
    public static Boolean playBattleShip() {
        ...
        List<String> gameBoard = newBoard(ROWS, COLS);
        List<String> userBoard = newBoard(ROWS, COLS);
        List<String> compBoard = newBoard(ROWS, COLS);
...
//            printBoard(compBoard);
    ...
    private static void mergeBoards(List<String> gameBoard, List<String> userBoard) {
    ...
    private static Boolean userMove(List<String> gameBoard, List<String> compBoard, List<String> userBoard, Scanner scanner) {
    ...
    private static Boolean isClose(List<String> board, int row, int col, String s) {
    ...
    private static Boolean compMove(List<String> gameBoard, List<String> compBoard, List<String> userBoard) {
        println("\nComputer shoots...");
...
//                    break;
    ...
    private static int countShips(List<String> board) {
        int ships = 0;
    ...
    private static List<String> newBoard(int rows, int cols) {
    ...
    private static String get(List<String> board, int row, int col) {
        if (0 <= row && row < boardRows(board)) {
            if (0 <= col && col < boardCols(board)) {
                return board.get(row).substring(col, col+1);
            }
        }
        return "";
    }

    private static void set(List<String> board, int row, int col, String value) {
        String rowString = board.get(row);
        board.set(row, rowString.substring(0, col) + value + rowString.substring(col+1));
    }

    private static Integer[] readCoords(Scanner scanner, String prompt, List<String> board) {
    ...
    private static List<Integer[]> assignUserShips(List<String> board, int n, Scanner scanner) {
    ...
    private static Integer[] randomCoords(List<String> board) {
    ...
    private static List<Integer[]> assignCompShips(List<String> compBoard, List<String> userBoard, int n) {
        List<Integer[]> ships = new ArrayList<Integer[]>();
        for (int i = 0; i < n; i++) {
    ...
    private static int boardRows(List<String> board) {
        return board.size();
    }
    private static int boardCols(List<String>  board) {
